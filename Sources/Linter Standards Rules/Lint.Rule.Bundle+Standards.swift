...
/// ruling 2026-07-07). Layer-3 Standards packages optimize for 1:1 spec
...
/// remain fully active at L2 (molecules) and L4 (compositions); the
...
extension Lint.Rule.Bundle {
    ...
    public static let standards: [Lint.Rule.Configuration] =
        Lint.Rule.Bundle.institute.excluding(rules: [
            ...
            // the specification and are exempt per [API-NAME-003] at L3.
            ...
            // are governed by [API-NAME-003] at L3.
